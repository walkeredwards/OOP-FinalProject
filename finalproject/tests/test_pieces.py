...
class TestKing(unittest.TestCase):
    ...
    def test_qcastle_f_1(self) -> None:
        """Test queen castle with a fail with piece in way"""
        expected = False
    ...
    def test_kcastle_f_1(self) -> None:
        """Test king castle with a fail with piece in way"""
        expected = False
    ...
    def test_castle_available_1(self) -> None:
        """test for castle available"""
        ...
        actual = piece.castle_available(location, other_location,
                                        pieces, other_pieces, True)

        self.assertEqual(expected, actual)

    def test_castle_available_2(self) -> None:
        """test for castle available"""
        expected = (True, False)
    ...
    def test_castle_available_3(self) -> None:
        """test for castle available"""
        expected = (False, True)
    ...
    def test_castle_available_4(self) -> None:
        """test for castle available"""
        expected = (True, True)
